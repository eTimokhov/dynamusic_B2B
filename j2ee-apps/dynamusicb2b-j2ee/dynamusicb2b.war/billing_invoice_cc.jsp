...
<dsp:page>
    ...
    <dsp:droplet name="PaymentGroupDroplet">
        ...
        <dsp:oparam name="output">
            ...
            <dsp:setvalue beanvalue="/atg/commerce/order/purchase/InvoiceRequestInitializer.invoiceRequestName"
                          param="invoiceRequestName"/>
                    ...
                    <td valign="top" width=745>
                        ...
                        <dsp:form action="billing.jsp" method="post">
                            <table border=0 cellpadding=4 width=80%>
                                ...
                                <tr valign=top>
                                    <td align=right width=25%><span class=smallb><b>Payment method <font size="1"><br>(names are credit cards)</font></b></span>
                                    </td>
                                    <td>
                                        <dsp:setvalue bean="PaymentGroupFormHandler.ListId" paramvalue="order.id"/>
                                        <dsp:input bean="PaymentGroupFormHandler.ListId"
                                                   beanvalue="PaymentGroupFormHandler.ListId" priority="<%=(int) 9%>"
                                                   type="hidden"/> <dsp:droplet name="ForEach">
                                            ...
                                            <dsp:droplet name="ForEach">
                                                ...
                                                <dsp:oparam name="output">
                                                    <dsp:input
                                                            ...
                                                            paramvalue="key" type="radio"/><dsp:valueof
                                                        param="key"/><br>
                                                </dsp:oparam>
                                            </dsp:droplet>
                                        </dsp:oparam>
                                ...
                                <dsp:setvalue bean="PaymentGroupFormHandler.PaymentGroupId"
                                              paramvalue="invoiceRequestName"/>
                                <dsp:input bean="PaymentGroupFormHandler.PaymentGroupId"
                                           beanvalue="PaymentGroupFormHandler.PaymentGroupId" priority="<%= (int) 9%>"
                                           type="hidden"/>
                                <tr valign=top>
                                    <td align="right"><span class=smallb>PO number</span></td>
                                    <td><dsp:input bean="PaymentGroupFormHandler.CurrentPaymentGroup.PONumber"
                                                   type="text" maxlength="40"/><br></td>
                                </tr>

                                <dsp:droplet name="IsEmpty">
                                    <dsp:param bean="PaymentGroupDroplet.defaultPaymentGroup.billingAddress"
                                               name="value"/>
                                    <dsp:oparam name="false">
                                        <tr valign="top">
                                            <td align="right"><span class=smallb>Billing Address</span></td>
                                            <td><dsp:getvalueof id="pval0"
                                                                bean="PaymentGroupDroplet.defaultPaymentGroup.billingAddress"><dsp:include
                                                    page="common/DisplayAddress.jsp" flush="false"><dsp:param
                                                    name="address"
                                                    value="<%=pval0%>"/></dsp:include></dsp:getvalueof><br>
                                                <dsp:droplet name="IsEmpty">
                                                    <dsp:param bean="Profile.billingAddrs" name="value"/>
                                                    <dsp:oparam name="false">
                                                        <span class=smallb><dsp:a
                                                                bean="PaymentAddressFormHandler.paymentGroupKey"
                                                                href="billing_address.jsp"
                                                                paramvalue="invoiceRequestName"><dsp:param name="source"
                                                                                                           value="billing.jsp?init=false"/>Change billing address</dsp:a></span>
                                                    </dsp:oparam>
                                                </dsp:droplet></td>
                                        </tr>
                                    </dsp:oparam>
                                ...
                                <tr>
                                    ...
                                    <td colspan=2><br>
                                        <dsp:input bean="PaymentGroupFormHandler.applyPaymentGroupsSuccessURL"
                                                   type="hidden" value="orderconfirm.jsp"/>
