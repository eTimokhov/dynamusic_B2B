        ...
        <tr>
            ...
            <td valign="top">
                <font face="Verdana,Geneva,Arial" color="midnightblue">
                    ...
                    <b>Order status:</b>
                        <dsp:valueof param="order.stateAsString"/>
                    </dsp:oparam>
                    </dsp:droplet>
                    <br>
                    ...
                    <b>Buyer: </b>
                        ...
                        <dsp:valueof param="item.lastName"/> (<dsp:valueof param="item.email">no email
                    address</dsp:valueof>),
                    ...
                    <nobr><dsp:valueof param="pGroup.billingAddress.companyName"/></nobr>
                    <br>
                    <nobr><dsp:valueof param="pGroup.billingAddress.address1"/></nobr>
                    <br>
                    <dsp:droplet name="IsEmpty">
                        <dsp:param name="value" param="pGroup.billingAddress.address2"/>
                    <dsp:oparam name="false">
                    <nobr><dsp:valueof param="pGroup.billingAddress.address2"/></nobr>
                    <br>
                    </dsp:oparam>
                    </dsp:droplet>
                    ...
                    Delivered to
                        <dsp:valueof param="sGroup.emailAddress"/>
                    </dsp:oparam>
                    <dsp:oparam name="default">
                    <b>Shipping address:</b><br>
                        <dsp:getvalueof id="pval0" param="sGroup.shippingAddress">
                    ...
                    <li>
                            <dsp:valueof param="CiRel.commerceItem.quantity"/>
                        ...
                        <b>Shipping:</b>
                            <dsp:getvalueof id="pval0" param="sGroup.priceInfo.amount">
                                <dsp:include page="DisplayCurrencyType.jsp" flush="false">
                                    <dsp:param name="currency" value="<%=pval0%>"/>
                                </dsp:include>
                            </dsp:getvalueof>
                        <br>
                        <b>Sales Tax:</b>
                            <dsp:getvalueof id="pval0" param="order.priceInfo.tax">
                                <dsp:include page="DisplayCurrencyType.jsp" flush="false">
                                    <dsp:param name="currency" value="<%=pval0%>"/>
                                </dsp:include>
                            </dsp:getvalueof><br>
                        ...
                        <b>Total:</b>
                            <dsp:getvalueof id="pval0" param="order.priceInfo.total">
                                <dsp:include page="DisplayCurrencyType.jsp" flush="false">
                                    <dsp:param name="currency" value="<%=pval0%>"/>
                                </dsp:include>
                            </dsp:getvalueof>
                        <br>
                                ...
                                <%/*Switch on Shipping Group Type*/%>

                            </dsp:oparam>
                                <%/*Switch on Shipping Group Size 1*/%>
                    ...
                    <li>
                        ...
                        <p>
                                    ...
                                    <%/*Switch on Shipping Group Type Default */%>
                                </dsp:droplet>
                                    <%/*Switch*/%>
                            </dsp:oparam>
