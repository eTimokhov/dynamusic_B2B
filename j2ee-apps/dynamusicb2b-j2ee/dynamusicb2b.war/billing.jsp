                            ...
                            <dsp:droplet name="/atg/dynamo/droplet/Switch">
                                ...
                                <dsp:oparam name="true">
                                    <dsp:droplet name="/atg/dynamo/droplet/Switch">
                                        ...
                                        <dsp:oparam name="true">
                                            <dsp:include page="billing_invoice_cc.jsp" flush="false"><dsp:param
                                                    name="init" value="true"/></dsp:include>
                                        </dsp:oparam>
                                        <dsp:oparam name="false">
                                            <dsp:include page="billing_invoice.jsp" flush="false"><dsp:param name="init"
                                ...
                                <dsp:oparam name="false">
                                    <dsp:include page="billing_cc.jsp" flush="false"><dsp:param name="init"
                                                                                                value="true"/></dsp:include>
                                </dsp:oparam>
                            ...
                            <dsp:droplet name="/atg/dynamo/droplet/Switch">
                                ...
                                <dsp:oparam name="true">
                                    <dsp:droplet name="/atg/dynamo/droplet/Switch">
                                        <dsp:param bean="Profile.creditCardAuthorized" name="value"/>
                                        <dsp:oparam name="false">
                                            <dsp:getvalueof id="pval1" param="init"><dsp:include
                                                    page="billing_invoice.jsp" flush="false"><dsp:param name="init"
                                                                                                        value="<%=pval1%>"/></dsp:include></dsp:getvalueof>
                                        </dsp:oparam>
                                        <dsp:oparam name="true">
                                            <dsp:getvalueof id="pval0" param="init"><dsp:include
                                                    page="billing_invoice_cc.jsp" flush="false"><dsp:param name="init"
                                ...
                                <dsp:oparam name="false">
                                    <dsp:getvalueof id="pval2" param="init"><dsp:include page="billing_cc.jsp"
                                                                                         flush="false"><dsp:param
                                            name="init" value="<%=pval2%>"/></dsp:include></dsp:getvalueof>
                                </dsp:oparam>
                                <dsp:oparam name="unset">
                                    <dsp:getvalueof id="pval3" param="init"><dsp:include page="billing_cc.jsp"
                                                                                         flush="false"><dsp:param
                                            name="init" value="<%=pval3%>"/></dsp:include></dsp:getvalueof>
                                </dsp:oparam>
                                <dsp:oparam name="default">
                                    <dsp:getvalueof id="pval4" param="init"><dsp:include page="billing_cc.jsp"
                                                                                         flush="false"><dsp:param
                                            name="init" value="<%=pval4%>"/></dsp:include></dsp:getvalueof>
                                </dsp:oparam>
                            </dsp:droplet>
