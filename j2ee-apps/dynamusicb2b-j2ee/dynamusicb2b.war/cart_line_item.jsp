...
<dsp:page>
    ...
    <dsp:droplet name="/atg/commerce/inventory/InventoryLookup">
        ...
        <dsp:oparam name="output">
            ...
            <dsp:getvalueof id="templateURL" param="item.auxiliaryData.productRef.template.url"
                            idtype="java.lang.String">
                <dsp:getvalueof id="displayName" param="item.auxiliaryData.catalogRef.displayName"
                                idtype="java.lang.String">
