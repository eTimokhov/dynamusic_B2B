                    ...
                    <table border=0 cellpadding=4 cellspacing=0>
                        ...
                        <dsp:droplet name="HasFunction">
                            ...
                            <dsp:oparam name="true">
                                <dsp:droplet name="Switch">
                                    ...
                                    <dsp:oparam name="true">
                                        <tr valign=top>
                                            <td><dsp:a href="orders_rejected.jsp">
                                                <nobr>Rejected orders</nobr>
                                            </dsp:a></td>
                                            <td>
                                            ...
                                            <td>Orders requiring approval that were returned to you by the approver.
                                            </td>
                                        </tr>
                                    </dsp:oparam>
                                </dsp:droplet>
                        ...
                        <tr valign=top>
                            ...
                            <td>If you are building an order and are not yet ready to place it you
                                can save the order and place it at a later time.
                            </td>
                        </tr>
