        ...
        <tr>
            ...
            <td valign="top">
                <font face="Verdana,Geneva,Arial" color="midnightblue">
                    ...
                    Order placed: <b><dsp:valueof date="M/dd/yyyy K:mm a"
                                                  param="result.submittedDate">No Submit Date</dsp:valueof></b><br>
                    Message: <b><dsp:valueof
                        bean="ApprovalFormHandler.approverMessage">no message sent.</dsp:valueof></b>
                    <p>
                    <p>
                        <dsp:a href="approvals.jsp">Back to approvals</dsp:a>
                        </dsp:oparam>
                        </dsp:droplet>
