                                    ...
                                    <table border=0 cellpadding=4 width=90%>
                                        ...
                                        <tr valign="top">
                                            <td align="right" width=25%><span
                                                    class=smallb>Select a billing address</span></td>
                                            <td>
                                            ...
                                            <dsp:droplet name="Switch">
                                                ...
                                                <dsp:getvalueof id="elemId" idtype="String" param="element.id">
                                                    <dsp:oparam name="<%=elemId%>">
                                                        <td><dsp:input bean="PaymentAddressFormHandler.addressId"
                                                                       paramvalue="element.id" type="radio"
                                                                       checked="<%=true%>"/></td>
                                                    </dsp:oparam>
                                                </dsp:getvalueof>
                                                ...
                                                <dsp:droplet name="IsEmpty">
                                                    ...
                                                    <dsp:oparam name="false">
                                                        <dsp:getvalueof id="pval0" param="element"><dsp:include
                                                                page="common/DisplayAddress.jsp"
                                                                flush="false"><dsp:param name="address"
                                        ...
                                        <tr>
                                            <td></td>
                                            <td colspan=2><br>
                                                <dsp:input bean="PaymentAddressFormHandler.paymentGroupKey"
                                                           beanvalue="PaymentAddressFormHandler.paymentGroupKey"
                                                           type="hidden"/>
                                                <dsp:input bean="PaymentAddressFormHandler.setAddressSuccessURL"
                                                           paramvalue="source" type="hidden"/>
                                                <dsp:input bean="PaymentAddressFormHandler.setAddress" type="submit"
                                                           value="Continue"/>
                                            </td>
                                        </tr>
                                    </table>
