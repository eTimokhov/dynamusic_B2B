        ...
        <tr>
            ...
            <td valign="top">
                <font face="Verdana,Geneva,Arial" color="midnightblue">
                    ...
                    <nobr><dsp:valueof bean="Profile.defaultShippingAddress.companyName"/></nobr>
                    <br>
                    <nobr><dsp:valueof bean="Profile.defaultShippingAddress.address1"/></nobr>
                    <br>
                    <dsp:droplet name="IsEmpty">
                        <dsp:param name="value" bean="Profile.defaultShippingAddress.address2"/>
                    <dsp:oparam name="false">
                    <nobr><dsp:valueof bean="Profile.defaultShippingAddress.address2"/></nobr>
                    <br>
                    </dsp:oparam>
                    </dsp:droplet>
                    ...
                    <table width="600" cellpadding="4"><font face="Verdana,Geneva,Arial" color="midnightblue">
                        <tr>
                            <td valign="bottom"><b>SKU</b></td>
                            <td valign="bottom"><b>Product</b></td>
                            <td valign="bottom"><b>Qty</b></td>
                            <td valign="bottom"><b>Qty to move</b></td>
                            <td valign="bottom"><b>Shipping Address</b></td>
                            <td valign="bottom"><b>Save Changes</b></td>
                        </tr>
                        ...
                        <tr valign=top>
                            ...
                            <td>
                                <nobr><dsp:valueof param="commerceItem.auxiliaryData.catalogRef.id"/></nobr>
                            </td>
                            ...
                            <td>
                                ...
                                <dsp:input bean="ShippingGroupFormHandler.currentList[param:index].splitQuantity"
                                           type="text" paramvalue="element.quantity" size="4"/>
                            ...
                            <td>
                                ...
                                <dsp:select
                                        bean="ShippingGroupFormHandler.currentList[param:index].splitShippingGroupName">
                                    <dsp:droplet name="ForEach">
                                                    ...
                                                    <dsp:getvalueof id="keyname" idtype="String" param="key">
                                                        <dsp:oparam name="<%=SGName%>">
                                                            <dsp:option selected="<%=true%>"
                                                                        value="<%=keyname%>"/><dsp:valueof
                                                                param="key"/>
                                                        </dsp:oparam>
                                                        <dsp:oparam name="default">
                                                            <dsp:option selected="<%=false%>"
                                                                        value="<%=keyname%>"/><dsp:valueof
                                                                param="key"/>
                                                        </dsp:oparam>
                                                    </dsp:getvalueof>
                            ...
                            <td>
                                <dsp:input bean="ShippingGroupFormHandler.splitShippingInfosSuccessURL" type="hidden"
                                           value="ship_to_multiple.jsp?init=false"/>
                                <dsp:input bean="ShippingGroupFormHandler.ListId" paramvalue="commerceItem.id"
                                           priority="<%=(int) 9%>" type="hidden"/>

                                <!-- Split shipping infos. -->
                                <dsp:input bean="ShippingGroupFormHandler.splitShippingInfos"
                        ...
                        <tr>
                            ...
                            <dsp:input bean="ShippingGroupFormHandler.applyShippingGroupsSuccessURL" type="hidden"
                                       value="shipping_method.jsp"/>
                            <td>
