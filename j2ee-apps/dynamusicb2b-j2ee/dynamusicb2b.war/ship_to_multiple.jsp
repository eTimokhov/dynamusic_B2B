...
<dsp:page>
    ...
    <tr>
        <td valign="bottom"><b>SKU</td>
        <td valign="bottom"><b>Product</td>
        <td valign="bottom"><b>Qty</td>
        <td valign="bottom"><b>Qty to move</td>
        <td valign="bottom"><b>Shipping Address</td>
        <td valign="bottom"><b>Save Changes</td>
    </tr>
                                        ...
                                        <dsp:getvalueof id="SGName" idtype="String" param="cisiItem.shippingGroupName">
                                            <dsp:getvalueof id="keyname" idtype="String" param="key">
                                                <dsp:oparam name="<%=SGName%>">
                                                    <dsp:option selected="<%=true%>" value="<%=keyname%>"/><dsp:valueof
                                                        param="key"/>
                                                </dsp:oparam>
                                                <dsp:oparam name="default">
                                                    <dsp:option selected="<%=false%>" value="<%=keyname%>"/><dsp:valueof
                                                        param="key"/>
                                                </dsp:oparam>
                                            </dsp:getvalueof>
                                        </dsp:getvalueof>
