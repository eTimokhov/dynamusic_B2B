                                ...
                                <tr valign=top>
                                    <td colspan=2>
                                        <table width=100% cellpadding=3 cellspacing=0 border=0>
                                            <tr>
                                                <td class=box-top>&nbsp;<font face="Verdana,Geneva,Arial"
                                                                              color="midnightblue" size="4">Shipping
                                                    Group <dsp:valueof param="count"/></font></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                ...
                                <dsp:droplet name="Switch">
                                    ...
                                    <dsp:oparam name="default">
                                        ...
                                        <tr valign=top>
                                            ...
                                            <td width=75%>
                                                <dsp:include page="common/DisplayAddress.jsp" flush="false"><dsp:param
                                                        name="address" param="sGroup.shippingAddress"/></dsp:include>
                                            </td>
                                        </tr>
                                        <tr valign=top>
                                                ...
                                                <table border=0 cellpadding=1 width=75%>
                                                    <dsp:droplet name="ForEach">
                                                        <dsp:param name="array"
                                                                   param="sGroup.CommerceItemRelationships"/>

                                                        <dsp:oparam name="output">
                                                            <dsp:param name="CiRel" param="element"/>
                                                            <tr valign=top>
                                                                <td><dsp:valueof param="CiRel.quantity"/>&nbsp;
                                                                    <dsp:a href="../catalog/product.jsp"><dsp:param
                                                                            name="id"
                                                                            param="CiRel.commerceItem.auxiliaryData.productId"/>
                                                                        <dsp:valueof
                                                                                param="CiRel.commerceItem.auxiliaryData.productRef.displayName"/></dsp:a></td>
                                                            </tr>
                                                        </dsp:oparam>
                                                    </dsp:droplet><%--ForEach--%>
                                                </table>
