        ...
        <tr>
            ...
            <td valign="top">
                <font face="Verdana,Geneva,Arial" color="midnightblue">
                    ...
                    <b>Subtotal:</b> <dsp:valueof bean="ShoppingCart.current.priceInfo.amount"
                    ...
                    <b>Total:</b> <dsp:valueof bean="ShoppingCart.current.priceInfo.total"
                                               converter="currency">no total</dsp:valueof>
                    <p>

                        Please click the "Confirm Order" button to finalize your order.
                    <p>
