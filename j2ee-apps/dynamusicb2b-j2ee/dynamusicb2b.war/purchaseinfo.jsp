                ...
                <font face="Verdana,Geneva,Arial" color="midnightblue">
                    ...
                    <p>
                        ...
                        <b>First Name:</b> <dsp:input
                            ...
                            beanvalue="Profile.firstName" size="30" type="text"/><br>
                        ...
                        <b>Last Name:</b> <dsp:input
                            ...
                            beanvalue="Profile.lastName" size="30" type="text"/><br>
                        <b>Address 1:</b> <dsp:input
                            bean="ExpressCheckoutFormHandler.shippingGroup.shippingAddress.address1"
                            beanvalue="Profile.shippingAddress.address1" size="30" type="text"/><br>
                        <b>Address 2:</b> <dsp:input
                            bean="ExpressCheckoutFormHandler.shippingGroup.shippingAddress.address2"
                            beanvalue="Profile.shippingAddress.address2" size="30" type="text"/><br>
                        <b>City:</b> <dsp:input bean="ExpressCheckoutFormHandler.shippingGroup.shippingAddress.city"
                                                beanvalue="Profile.shippingAddress.city" size="30" type="text"
                                                required="<%=true%>"/><br>
                        <b>State:</b> <dsp:input bean="ExpressCheckoutFormHandler.shippingGroup.shippingAddress.state"
                                                 maxsize="2" beanvalue="Profile.shippingAddress.state" size="2"
                        ...
                        <b>Postal Code:</b> <dsp:input
                            ...
                            beanvalue="Profile.shippingAddress.postalCode" size="10" type="text"
                            required="<%=true%>"/><br>
                        <b>Country:</b> <dsp:input
                            bean="ExpressCheckoutFormHandler.shippingGroup.shippingAddress.country"
                            beanvalue="Profile.shippingAddress.country" size="10" type="text"/><br>
                        <b>Email:</b> <dsp:input bean="ExpressCheckoutFormHandler.shippingGroup.shippingAddress.email"
                                                 beanvalue="Profile.email" size="30" type="text"
                                                 required="<%=true%>"/><br>
                        <b>Phone:</b> <dsp:input
                        bean="ExpressCheckoutFormHandler.shippingGroup.shippingAddress.phoneNumber"
                        beanvalue="Profile.daytimeTelephoneNumber" size="12" type="text"/><P>
                    ...
                    <b>Middle Name:</b> <dsp:input
                        ...
                        beanvalue="Profile.middleName" size="30" type="text"/><br>
                    <b>Last Name:<b> <dsp:input bean="ExpressCheckoutFormHandler.paymentGroup.billingAddress.lastName"
                        ...
                        <b>City:</b> <dsp:input bean="ExpressCheckoutFormHandler.paymentGroup.billingAddress.city"
                                                beanvalue="Profile.billingAddress.city" size="30" type="text"
                                                required="<%=true%>"/><br>
                        <b>State:</b> <dsp:input bean="ExpressCheckoutFormHandler.paymentGroup.billingAddress.state"
                                                 maxsize="2" beanvalue="Profile.billingAddress.state" size="2"
                                                 type="text" required="<%=true%>"/><br>
                        <b>Postal Code:</b> <dsp:input
                            ...
                            required="<%=true%>"/><br>
                        <b>Country:</b> <dsp:input bean="ExpressCheckoutFormHandler.paymentGroup.billingAddress.country"
                                                   beanvalue="Profile.billingAddress.country" size="10"
                                                   type="text"/><br>
                    <p>
                    ...
                    <p>
                            ...
                            <dsp:input bean="ExpressCheckoutFormHandler.expressCheckout" type="submit"
                                       value="Confirm Order"/>
                        </dsp:form>
                </font>
            </td>
