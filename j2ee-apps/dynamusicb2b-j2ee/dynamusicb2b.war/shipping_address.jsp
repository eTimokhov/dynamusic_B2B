                ...
                <dsp:form action="shipping_address.jsp" method="post">
                    <table border=0 cellpadding=4 width=90%>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                    <dsp:input bean="B2BRepositoryFormHandler.repositoryId" beanvalue="Profile.id"
                                               type="hidden"/>
                        ...
                        <tr valign=top></dsp:oparam>
                            <dsp:oparam name="outputRowEnd"></tr>
                        </dsp:oparam>
                            ...
                            <dsp:droplet name="Switch">
                                ...
                                <dsp:getvalueof id="addressId" idtype="String" bean="Profile.defaultShippingAddress.id">
                                    ...
                                    <dsp:oparam name="<%=addressId%>">
                                        ...
                                        <td><dsp:input
                                                bean="B2BRepositoryFormHandler.value.defaultShippingAddress.repositoryId"
                                                paramvalue="element.id" type="radio" checked="<%=true%>"/></td>
                                        <td><dsp:getvalueof idtype="atg.repository.RepositoryItem" id="pval0"
                                                            param="element"><dsp:include
                                                page="../common/DisplayAddress.jsp" flush="false"><dsp:param
                                                name="address" value="<%=pval0%>"/></dsp:include></dsp:getvalueof>
                                        </td>
                                    </dsp:oparam>
                                </dsp:getvalueof>
                                ...
                                <dsp:oparam name="default">
                                    <td><dsp:input
                                            bean="B2BRepositoryFormHandler.value.defaultShippingAddress.repositoryId"
                                            paramvalue="element.id" type="radio"/></td>
                                    <td>
                                        <dsp:getvalueof id="pval0" idtype="atg.repository.RepositoryItem"
                                                        param="element"><dsp:include page="../common/DisplayAddress.jsp"
                        ...
                        <tr>
                            <td></td>
                            <td colspan=2><br>
                                <dsp:input bean="B2BRepositoryFormHandler.updateSuccessURL" type="hidden"
                                           value="shipping.jsp"/>
                                <dsp:input bean="B2BRepositoryFormHandler.updateErrorURL" type="hidden"
                                           value="shipping_address.jsp"/>
